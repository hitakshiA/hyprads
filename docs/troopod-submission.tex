...
\small
\begin{tabular}{cl}
\textcolor{accent}{\textbf{INPUT}} & Ad Creative (text / image / URL) + Landing Page URL \\[4pt]
$\downarrow$ & \\
\textcolor{accent}{\textbf{1. CLONE}} & Playwright headless $\rightarrow$ scroll $\rightarrow$ bake styles $\rightarrow$ inline CSS $\rightarrow$ strip JS \\[4pt]
$\downarrow$ & \\
\textcolor{accent}{\textbf{2. ANALYZE}} & Claude Opus 4.6 (multimodal) $\rightarrow$ offer, audience, tone, CTA intent \\[4pt]
$\downarrow$ & \\
\textcolor{accent}{\textbf{3. PERSONALIZE}} & Edit tool: headline $\rightarrow$ subheadline $\rightarrow$ CTA $\rightarrow$ trust signals \\[4pt]
$\downarrow$ & \\
\textcolor{accent}{\textbf{4. VISUAL QA}} & Screenshot $\rightarrow$ compare with original $\rightarrow$ fix broken elements $\rightarrow$ repeat \\[4pt]
$\downarrow$ & \\
\textcolor{accent}{\textbf{OUTPUT}} & Personalized HTML + Change Report + Ad Analysis \\
\end{tabular}
\end{center}
